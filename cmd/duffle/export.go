...
const exportDesc = `
Packages an invocation image together with all of its associated images and generaetes a single gzipped tarfile
...
func newExportCmd(w io.Writer) *cobra.Command {
	...
	f.BoolVarP(&export.full, "full", "f", true, "Save bundle with all associated images")
